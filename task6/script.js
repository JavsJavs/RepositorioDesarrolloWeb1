...
function loadItems() {
    ...
    for (let i = 0; i < json.results.length; i++) {
        ...
        film.className="card";
        {
            ...
            photoContainerDiv.innerHTML+= `<img src=" https://image.tmdb.org/t/p/w500/${json.results[i].poster_path}">`;
            ...
            textDiv.className = "text";
            {
                ...
                mainTextDiv.className = "mainText";
                {
                    ...
                    filmTitleDiv.innerHTML = `<strong><a href="https://dictionary.cambridge.org/es/diccionario/ingles/title">${json.results[i].title}</a></strong>`;
                    filmTitleDiv.innerHTML += `(${json.results[i].release_date})`;
                    ...
                    directorDiv.innerHTML = `<a href="https://es.wikipedia.org/wiki/Francis_Ford_Coppola">Francis Ford Copola</a>`;
                    mainTextDiv.appendChild(directorDiv);

                    let castDiv = document.createElement("div");
                    castDiv.className = "cast";
                    castDiv.innerHTML = `<a href="https://dictionary.cambridge.org/es/diccionario/ingles/overview">${json.results[i].overview}</a>`;
                ...
                reviewsDiv.className = "reviews";
                {
                    ...
                    scoreDiv.innerHTML = `${json.results[i].vote_average}`;
                    reviewsDiv.appendChild(scoreDiv);

                    let usersDiv = document.createElement("div");
                    usersDiv.className = "users";
                    usersDiv.innerHTML = `${json.results[i].vote_count} `;
        ...
        //filmList.innerHTML += `<li>${json.results[i].title}</li>`;
    }
...
/*  <div class="tarjeta">
        ...
        <div>
            <img src="https://pics.filmaffinity.com/the_godfather-529853536-msmall.jpg" class="photo">
        </div>

        <div class="text">
            <div class="maintext">
                <div class="filmtitle">
                    <strong><a href="https://es.wikipedia.org/wiki/Padrino">El Padrino</a></strong> (1972)
                    <img src="https://www.onlinestores.com/flagdetective/images/download/us/us-betsy-ross-hi.jpg" class="flag">
                </div>
                <div class="director">
                    <a href="https://www.ford.es/">Francis Ford Coppola </a>
                </div>
                <div class="cast">
        ...
        `   <div class="reviews">
                <div class="score">
                 ...
                 <div>
                    177.902
                    <img src="https://www.library.caltech.edu/sites/default/files/styles/headshot/public/default_images/user.png?itok=1HlTtL2d.png" class="usrimg">
                </div>
            </div>
        </div>
